...
export class DeadEntryReportComponent implements OnInit {
  ...
  loadData() {
    ...
    this.API.getsingleid('BatchMaster', this.entryId).subscribe((res) => {
      ...
      this.API.DataBybatchNamedescdata01('DeadEntry', this.bacthNameForpach, userid).subscribe((res) => {
    ...
    // this.API.DataByUserIdascdata("DeadEntry", userid).subscribe((res) => {
    //   this.loadTableData = res
    // })
  }
